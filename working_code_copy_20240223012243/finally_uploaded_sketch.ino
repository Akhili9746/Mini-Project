...
const char *ssid = "SPECULUM1";
const char *password = "20H220H2";
IPAddress staticIP(192, 168, 203, 219);
IPAddress gateway(192, 168, 142, 95); // Replace this with your gateway IP Address
IPAddress subnet(255, 255, 255, 0);   // Replace this with your Subnet Mask
IPAddress dns(192, 168, 142, 95);
...
// HTTP request handler for controlling the pin
